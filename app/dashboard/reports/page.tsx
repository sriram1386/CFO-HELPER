  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-600 mt-1">Generate and manage your financial reports and analyses.</p>
      </div>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="p-4 bg-slate-50 rounded-lg">
                <h4 className="font-medium mb-2">{selectedReportType?.label}</h4>
                <p className="text-sm text-slate-600 mb-3">{selectedReportType?.description}</p>
                <div className="space-y-2 text-sm">
                  <div className="flex items-center gap-2">
                    <Calendar className="h-4 w-4 text-slate-400" />
                    <span>Time frame: {timeframe} months</span>
                  </div>
                  {includeCharts && (
                    <div className="flex items-center gap-2">
                  ...
                  {includeForecasts && (
                    <div className="flex items-center gap-2">
                      ...
                      <span>Financial forecasts included</span>
                    </div>
                  )}
                  {includeScenarios && (
                    <div className="flex items-center gap-2">
                      <DollarSign className="h-4 w-4 text-purple-600" />
                      <span>Scenario comparisons included</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="border-t pt-4">
                <h5 className="font-medium mb-2">Estimated Content</h5>
